...
# Get unique values from the 'site', 'gender', 'age', 'sample_type', and 'findings' columns
...
# Filter the data based on the selected sites, gender, age, sample type, and findings
